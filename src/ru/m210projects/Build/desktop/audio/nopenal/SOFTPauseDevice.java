...
/**
 * Native bindings to the <a target="_blank" href="http://kcat.strangesoft.net/openal-extensions/SOFT_pause_device.txt">SOFT_pause_device</a> extension.
 * 
...
public class SOFTPauseDevice {
    ...
    public static void alcDevicePauseSOFT(ALCdevice device) {
        getNative().alcDevicePauseSOFT(device);
    }
    ...
    public static void alcDeviceResumeSOFT(ALCdevice device) {
        getNative().alcDeviceResumeSOFT(device);
    }
}