...
/**
 * Native bindings to the <a target="_blank" href="http://kcat.strangesoft.net/openal-extensions/SOFT_HRTF.txt">SOFT_HRTF</a> extension.
 * 
...
public class SOFTHRTF {
    ...
    public static String alcGetStringiSOFT(ALCdevice device, int paramName, int index) {
        return getNative().alcGetStringiSOFT(device, paramName, index);
    }
    ...
    public static boolean alcResetDeviceSOFT(ALCdevice device, IntBuffer attrList) {
        return getNative().alcResetDeviceSOFT(device, attrList);
    }

    /** Array version of: {@link #alcResetDeviceSOFT ResetDeviceSOFT} */
    public static boolean alcResetDeviceSOFT(ALCdevice device, int[] attrList) {
    	return getNative().alcResetDeviceSOFT(device, attrList);
    }
