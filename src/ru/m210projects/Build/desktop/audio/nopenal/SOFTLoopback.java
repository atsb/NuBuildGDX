...
public class SOFTLoopback {
    ...
    public static ALCdevice alcLoopbackOpenDeviceSOFT(String deviceName) {
    	return getNative().alcLoopbackOpenDeviceSOFT(deviceName);
    }
    ...
    public static boolean alcIsRenderFormatSupportedSOFT(ALCdevice device, int frequency, int channels, int type) {
        return getNative().alcIsRenderFormatSupportedSOFT(device, frequency, channels, type);
    }
    ...
    public static void alcRenderSamplesSOFT(ALCdevice device, ByteBuffer buffer, int samples) {
    	getNative().alcRenderSamplesSOFT(device, buffer, samples);
    }
    ...
    public static void alcRenderSamplesSOFT(ALCdevice device, ShortBuffer buffer, int samples) {
    	getNative().alcRenderSamplesSOFT(device, buffer, samples);
    }
    ...
    public static void alcRenderSamplesSOFT(ALCdevice device, IntBuffer buffer, int samples) {
    	getNative().alcRenderSamplesSOFT(device, buffer, samples);
    }
    ...
    public static void alcRenderSamplesSOFT(ALCdevice device, FloatBuffer buffer, int samples) {
    	getNative().alcRenderSamplesSOFT(device, buffer, samples);
    }

    /** Array version of: {@link #alcRenderSamplesSOFT RenderSamplesSOFT} */
    
    public static void alcRenderSamplesSOFT(ALCdevice device, short[] buffer, int samples) {
        getNative().alcRenderSamplesSOFT(device, buffer, samples);
    }

    /** Array version of: {@link #alcRenderSamplesSOFT RenderSamplesSOFT} */
    
    public static void alcRenderSamplesSOFT(ALCdevice device, int[] buffer, int samples) {
        getNative().alcRenderSamplesSOFT(device, buffer, samples);
    }

    /** Array version of: {@link #alcRenderSamplesSOFT RenderSamplesSOFT} */
    
    public static void alcRenderSamplesSOFT(ALCdevice device, float[] buffer, int samples) {
        getNative().alcRenderSamplesSOFT(device, buffer, samples);
    }
}