...
public abstract class RREntry extends GameEntry {

	public RREntry() {
		super("NuRedneckGDX", appversion);
	}

	@Override
	public URL getLogo() {
		return this.getClass().getResource("/" +headerPath + "/headerrr.png");
	}

	@Override
	public URL getIcon16() {
		return this.getClass().getResource("/" +iconPath + "/RR/rr16.png");
	}
	...
	public String[] getIcons() {
		String icons[] = {
			iconPath + "/RR/rr16.png",
			iconPath + "/RR/rr32.png",
			iconPath + "/RR/rr128.png",
		};
	...
	public CheckFiles checkResources(String path, boolean errorMessage) {
		...
		for (int i = 0; i < resources.length; i++) {
			...
			if(resources[i].name.equals("redneck.grp") && filesMap.get(resources[i].name).length() == 191798609 ) {
				found = false;
