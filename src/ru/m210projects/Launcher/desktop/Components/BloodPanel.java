...
public class BloodPanel extends GamePanel {
	...
	public BloodPanel(JLauncher main, BloodEntry entry, boolean isPortable) {
		super(entry);
		this.main = main;
		this.isPortable = isPortable;

		main.services.registerGame(Service.GOG, entry, //
