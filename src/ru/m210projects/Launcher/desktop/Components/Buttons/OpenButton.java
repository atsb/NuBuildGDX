...
public class OpenButton extends JButton {
	...
	public OpenButton() {
		setToolTipText("Open folder");
		setIcon(new ImageIcon(Toolkit.getDefaultToolkit().createImage(this.getClass().getResource("/" + iconPath + "/iconopen.png"))));
	...
	public OpenButton update(String path) {
		this.path = path;
		return this;
	}
}
