...
public class WHPanel extends GamePanel {
	...
	public WHPanel(JLauncher main, WHEntry entry, boolean isPortable) {
		super(entry);
		this.main = main;
		this.isPortable = isPortable;

		main.services.registerGame(GameServices.Service.GOG, entry,
				"[GOG]:\\" + "Games\\1315510047");

		main.services.registerGame(GameServices.Service.Steam, entry,
				"[Steam]:\\" + "Witchaven" + File.separator + "Enhanced" + File.separator + "GAME" + File.separator + "WHAVEN");
	}
					...
					public void popupMenuWillBecomeVisible(PopupMenuEvent e) {
						if (!Init) {
							for (GameServices.GameLabel label : labels) {
								if(label.label.equals("[GOG]"))
									label.path += "Enhanced\\GAME\\WHAVEN\\";
