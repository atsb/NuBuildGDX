...
import ru.m210projects.Launcher.desktop.GameServices.GameLabel;
import ru.m210projects.Launcher.desktop.GameServices.Service;

public class DukePanel extends GamePanel {
	...
	public DukePanel(JLauncher main, DukeEntry entry, boolean isPortable) {
		...
		main.services.registerGame(Service.GOG, entry, "[GOG]:\\" + "GOGDUKE3D");

		main.services.registerGame(Service.Steam, entry,
		...
		main.services.registerGame(Service.Other, entry, "[Zoom]:\\"
				+ "HKLM\\Software\\WOW6432Node\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\{701DE32E-4F6E-4524-9966-837165B91EB9}_is1",
				"[Zoom]:\\"
						+ "HKLM\\Software\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\{701DE32E-4F6E-4524-9966-837165B91EB9}_is1",
	...
	public void init() {
		...
		if (!isPortable) {
			final ArrayList<GameLabel> labels = new ArrayList<>(main.services.getPaths(entry));
			if (labels.size() > 0) {
