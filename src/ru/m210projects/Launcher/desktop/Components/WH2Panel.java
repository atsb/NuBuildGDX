...
public class WH2Panel extends GamePanel {
	...
	public WH2Panel(JLauncher main, WH2Entry entry, boolean isPortable) {
		...
		main.services.registerGame(GameServices.Service.GOG, entry,
				"[GOG]:\\" + "Games\\1073977251");

		main.services.registerGame(GameServices.Service.Steam, entry,
				"[Steam]:\\" + "Witchaven II Blood Vengeance" + File.separator + "Enhanced" + File.separator + "GAME" + File.separator + "WHAVEN2");
	}
						...
						if (!Init) {
							for (GameServices.GameLabel label : labels) {
								if(label.label.equals("[GOG]"))
									label.path += "Enhanced\\GAME\\WHAVEN2\\";
