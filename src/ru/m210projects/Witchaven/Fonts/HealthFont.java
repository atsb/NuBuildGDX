...
import static ru.m210projects.Witchaven.Names.SHEALTHFONT;

import ru.m210projects.Build.Engine;
import ru.m210projects.Build.Pattern.BuildFont;

public class HealthFont extends BuildFont {

	public HealthFont(Engine draw) {
		super(draw, 38, 65536, 8 | 16);

		this.addChar(' ', nSpace, 20, nScale, 0, 0);

		for(int i = 0; i < 10; i++) {
			int nTile = i + SHEALTHFONT;
