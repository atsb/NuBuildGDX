...
import static ru.m210projects.Witchaven.AI.Ai.FATWITCHTYPE;
...
import static ru.m210projects.Witchaven.WH1Names.FATWITCH;
import static ru.m210projects.Witchaven.WH1Names.FATWITCHATTACK;
import static ru.m210projects.Witchaven.WH1Names.FATWITCHCHAR;
import static ru.m210projects.Witchaven.WH1Names.FATWITCHDEAD;
...
public class AIFatwitch {
	...
	public static void create() {
		...
		enemy[FATWITCHTYPE].resurect = new AIState() {
			@Override
			public void process(PLAYER plr, short i) {
				SPRITE spr = sprite[i];
	...
	public static void throwspank(PLAYER plr, int i) {
		...
		sprite[j].z = sector[sprite[i].sectnum].floorz - ((engine.getTile(sprite[i].picnum).getHeight() >> 1) << 8);
