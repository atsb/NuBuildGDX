...
import static ru.m210projects.Witchaven.AI.Ai.FREDTYPE;
...
import static ru.m210projects.Witchaven.WH1Names.FRED;
...
public class AIFred {
	...
	public static void create() {
		enemy[FREDTYPE] = new Enemy();
		enemy[FREDTYPE].info = new EnemyInfo(48, 48, 1024 + 256, 120, 0, 64, false, 40, 0);
		enemy[FREDTYPE].chase = new AIState() {
			@Override
		...
		enemy[FREDTYPE].skirmish = new AIState() {
			@Override
			public void process(PLAYER plr, short i) {
				SPRITE spr = sprite[i];
		...
		enemy[FREDTYPE].die = new AIState() {
			@Override
			public void process(PLAYER plr, short i) {
				SPRITE spr = sprite[i];
				spr.lotag -= TICSPERFRAME;
		...
		enemy[FREDTYPE].search = new AIState() {
			@Override
			public void process(PLAYER plr, short i) {
		...
		enemy[FREDTYPE].frozen = new AIState() {
			@Override
			public void process(PLAYER plr, short i) {
				SPRITE spr = sprite[i];
		...
		enemy[FREDTYPE].face = new AIState() {
			@Override
			public void process(PLAYER plr, short i) {
				SPRITE spr = sprite[i];
		...
		enemy[FREDTYPE].attack = new AIState() {
			@Override
			public void process(PLAYER plr, short i) {
				SPRITE spr = sprite[i];
		...
		enemy[FREDTYPE].flee = new AIState() {
			@Override
			public void process(PLAYER plr, short i) {
				SPRITE spr = sprite[i];
				spr.lotag -= TICSPERFRAME;
		...
		enemy[FREDTYPE].pain = new AIState() {
			@Override
			public void process(PLAYER plr, short i) {
				SPRITE spr = sprite[i];
				spr.lotag -= TICSPERFRAME;
		...
		enemy[FREDTYPE].resurect = new AIState() {
			@Override
			public void process(PLAYER plr, short i) {
				SPRITE spr = sprite[i];
