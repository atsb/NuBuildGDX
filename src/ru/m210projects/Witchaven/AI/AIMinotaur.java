...
import static ru.m210projects.Witchaven.AI.Ai.MINOTAURTYPE;
...
import static ru.m210projects.Witchaven.Names.MINOTAUR;
import static ru.m210projects.Witchaven.Names.MINOTAURDEAD;
import static ru.m210projects.Witchaven.Names.MONSTERBALL;
import static ru.m210projects.Witchaven.Names.SMOKEFX;
import static ru.m210projects.Witchaven.WH1Names.MINOTAURCHAR;
...
public class AIMinotaur {

	public static void create() {

		engine.getTile(MINOTAUR + 16).anm = 0;

		enemy[MINOTAURTYPE] = new Enemy();
		enemy[MINOTAURTYPE].info = new EnemyInfo(64, 64, 1024 + 512, 120, 0, 64, false, game.WH2 ? 80 : 100, 0);
		enemy[MINOTAURTYPE].chase = new AIState() {
			@Override
		...
		enemy[MINOTAURTYPE].resurect = new AIState() {
			@Override
			public void process(PLAYER plr, short i) {
				SPRITE spr = sprite[i];
		...
		enemy[MINOTAURTYPE].skirmish = new AIState() {
			@Override
			public void process(PLAYER plr, short i) {
				SPRITE spr = sprite[i];
		...
		enemy[MINOTAURTYPE].nuked = new AIState() {
			@Override
			public void process(PLAYER plr, short i) {
				SPRITE spr = sprite[i];
		...
		enemy[MINOTAURTYPE].pain = new AIState() {
			@Override
			public void process(PLAYER plr, short i) {
				SPRITE spr = sprite[i];
				spr.lotag -= TICSPERFRAME;
		...
		enemy[MINOTAURTYPE].face = new AIState() {
			@Override
			public void process(PLAYER plr, short i) {
				SPRITE spr = sprite[i];
		...
		enemy[MINOTAURTYPE].attack = new AIState() {
			@Override
			public void process(PLAYER plr, short i) {
				SPRITE spr = sprite[i];
		...
		enemy[MINOTAURTYPE].die = new AIState() {
			@Override
			public void process(PLAYER plr, short i) {
				SPRITE spr = sprite[i];
				spr.lotag -= TICSPERFRAME;
		...
		enemy[MINOTAURTYPE].flee = new AIState() {
			@Override
			public void process(PLAYER plr, short i) {
				SPRITE spr = sprite[i];
				spr.lotag -= TICSPERFRAME;
		...
		enemy[MINOTAURTYPE].frozen = new AIState() {
			@Override
			public void process(PLAYER plr, short i) {
				SPRITE spr = sprite[i];
		...
		enemy[MINOTAURTYPE].search = new AIState() {
			@Override
			public void process(PLAYER plr, short i) {
