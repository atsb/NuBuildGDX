...
public class BLMenuMouse extends MenuMouse {

	public BLMenuMouse(Main app) {
		super(app, 20, 40, 280, 10, 5, app.getFont(3), 0);
		
		addItem(app.menu.addMenuBlood(), false);
		advancedMenu.addItem(app.menu.addMenuBlood(), false);
	}
